  ...
  <Layout>
    <div id="main">
      <div className="inner">
        ...
        <h1>
          <a href="https://creare-site-relativity.websitemarket.ro/">Creare Site Relativity</a>
        </h1>
      
        <span className="image main">
            <img alt="Creare Site cu design Relativity. Un produs WebsiteMarket."
                 src="https://raw.githubusercontent.com/creare-site/static/master/produse/creare-site-relativity-intro.gif"/>
        </span>
