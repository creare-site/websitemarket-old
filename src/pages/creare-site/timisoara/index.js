...
const IndexPage = () => (
  <Layout>
    ...
    <SEO title="Creare Site Timisoara - Site-uri de Prezentare" 
         description="Site-uri de prezentare pentru Timisoara. Produse digitale WebsiteMarket." />

    <div id="main">
      <div className="inner">

        <h1>
          Creare <a href="https://ro.wikipedia.org/wiki/Site_web">site</a> <a href="https://ro.wikipedia.org/wiki/Timisoara">Timisoara</a>
        </h1>

        <p>
          Daca locuiesti in <b>Timisoara</b> si desfasori o activitate care are nevoie de un <b><a href="https://ro.wikipedia.org/wiki/Site_web">Site Web</a></b>{' '} 
