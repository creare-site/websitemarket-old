...
const IndexPage = () => (
  <Layout>
    ...
    <SEO title="Site Gratuit - Site de Prezentare cu design Paper" 
    ...
    <div id="main">
      <div className="inner">
        ...
        <h1>
          <a href="https://site-gratuit-paper.websitemarket.ro">Site Gratuit Paper</a>
        </h1>
        ...
        <p>
            ...
            <ul>
                <li>
                    Acceseaza <strong><a href="https://site-gratuit-paper.websitemarket.ro">Demo Site Gratuit</a></strong>
                </li>
        ...
        <blockquote>
            <h5>WebsiteMarket</h5>
            Hai pe net! Acum este simplu utilizand un <a href="https://github.com/creare-site/site-gratuit-paper">Site Gratuit</a> {' '}
