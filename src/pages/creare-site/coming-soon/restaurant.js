...
const IndexPage = () => (
  <Layout>
    ...
    <SEO title="Site Restaurant - Pagina Coming Soon" 
         description="Site de prezentare potrivit restaurantelor. Produs digital WebsiteMarket." /> 
    ...
    <div id="main">
      <div className="inner">
        ...
        <p>
            Acest design simplu si modern are un format potrivit restaurantelor si cafenelelor. 
        </p>
