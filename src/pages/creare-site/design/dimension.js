...
const IndexPage = () => (
  <Layout>
  <SEO title="Creare Site - Design Dimension" 
       description="Site Prezentare rapid cu design Dimension. Un produs WebsiteMarket." />

    <div id="main">
      <div className="inner">

        <h1>
            <a href="https://site-prezentare-dimension.websitemarket.ro/">Creare Site Dimension</a>
        </h1>
      
        <span className="image main">
            <img alt="Creare Site cu design Construct. Un produs WebsiteMarket."
                 src="https://raw.githubusercontent.com/creare-site/static/master/produse/creare-site-dimension-intro.gif"/>
        </span>
