  ...
  <Layout>
    ...
    <div id="main">
      <div className="inner">
        ...
        <h1>
          Creare <a href="https://ro.wikipedia.org/wiki/Site_web">site</a> <a href="https://ro.wikipedia.org/wiki/Suceava">Suceava</a>
        </h1>

        <p>
          Daca locuiesti in <b>Suceava</b> si desfasori o activitate care are nevoie de un <b><a href="https://ro.wikipedia.org/wiki/Site_web">Site Web</a></b>{' '} 
