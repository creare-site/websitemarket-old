...
const IndexPage = () => (
  <Layout>
    <SEO title="Creare Site - Design Lens" 
         description="Site Prezentare rapid cu design Lens. Un produs WebsiteMarket." />

    <div id="main">
      <div className="inner">

        <h1>
            <a href="https://creare-site-lens.websitemarket.ro/">Creare Site Lens</a>
        </h1>
      
        <span className="image main">
            <img alt="Creare Site cu design Lens. Un produs WebsiteMarket."
                 src="https://raw.githubusercontent.com/creare-site/static/master/produse/creare-site-lens-intro.gif"/>
        </span>
